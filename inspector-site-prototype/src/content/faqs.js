export const inspectorFaqGroups = [
  {
    ...
    items: [
      ...
      ["Do you offer weekend appointments?", "Availability changes. Share the timing you need and C&G will confirm what is currently available. No specific day or weekend policy is published until the owner approves it."],
      ["What property types do you inspect?", "Residential property types are confirmed when scheduling. The site does not promise a specific special property type until it is approved and supported by the inspection agreement."],
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      ["Do you use special tools?", "Specific tools are not promised until their use is owner-confirmed. Tools can support an observation but do not turn a visual inspection into destructive testing, engineering analysis, or a guarantee that a concealed condition will be found."],
  ...
  },
  {
    ...
    items: [
      ["When will I receive the report?", "C&G will confirm the expected delivery timing when the inspection is scheduled. The site does not promise a universal delivery time."],
  ...
  },
  {
    ...
    items: [
      ...
      ["Do you inspect pools, spas, sewer lines, solar, mold, or termites?", "Only services specifically approved, scheduled, and included in the signed agreement may be represented as available. Otherwise, those systems or tests require a separate qualified provider."],
  ...
  },
  {
    ...
    items: [
      ["What areas do you serve?", "Provide the full property address so C&G can confirm current coverage, travel, and availability. No county or city list is published until the owner approves the service-area registry."],
