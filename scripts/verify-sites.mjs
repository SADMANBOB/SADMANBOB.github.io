...
assert.match(inspectorSource, /visual, non-invasive review/i, "Inspector scope boundary guidance is missing");
assert.match(inspectorSource, /Four details make scheduling easier/i, "Inspector contact preparation guidance is missing");
