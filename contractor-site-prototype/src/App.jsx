...
function Home({ onNavigate }) {
  ...
  const planningPhoto = approvedClientPhotoReplacement("contractor-project-planning", PUBLICATION_SURFACES.contractorHomePhoto);
  return <>
